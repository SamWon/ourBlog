...
;(function($){
	...
	$.fn.coffee = function(option){
		...
		$coffee.append('<div class="coffee-steam-box" style="height:'+ opts.steamTopMax+'px; width:'+ '100' +'px; left:0px;top:-'+ opts.steamTopMax+'px;position:absolute;overflow:hidden;z-index:0;"></div>');
